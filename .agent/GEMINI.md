...
> **v3.9.98** | 51 Skills • 21 Agents • 18 Workflows | [github.com/pikakit](https://github.com/pikakit/agent-skills)
...
| Trigger | Branding |
|---------|----------|
| Workflow execution | Header: `🤖 PikaKit v3.9.98 / Workflow: /name` + Footer: `⚡ PikaKit v3.9.98 / [Tagline]` |
