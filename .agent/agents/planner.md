...
model: inherit
skills: code-craft, app-scaffold, project-planner, idea-storm, skill-generator
---
...
> 🔴 **ENFORCEMENT: You MUST execute these verification scripts!**
...
python .agent/skills/E2EAutomation/scripts/playwright_runner.py http://localhost:3000 --screenshot
```
