...
graph TD
    ...
    CON004 --> ADR004["ADR-004: FTS5 Search Index"]

    ADR004 --> FTS5["FTS5: knowledge_fts table"]
    ADR004 --> SECGATE["Secret Prefilter Gate"]
    ...
    SIG --> SIG008["SIG-008: Knowledge Hardening"]
    ...
    style ADR004 fill:#f59e0b,color:#fff

    style FTS5 fill:#06b6d4,color:#fff
    style SECGATE fill:#ef4444,color:#fff

    style SIG006 fill:#ef4444,color:#fff
    style SIG007 fill:#ef4444,color:#fff
    style SIG008 fill:#ef4444,color:#fff
