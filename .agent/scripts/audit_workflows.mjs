...
for (const f of files) {
  ...
  if (!/auto-learned|Auto-Learned|auto-learned\/patterns/i.test(txt)) issues.push('Missing Auto-Learned Pattern check');
  if (!/Exit Gate|Problem Verification|@\[current_problems\]/i.test(txt)) issues.push('Missing Exit Gates');
  if (!/Rollback|recovery|checkpoint/i.test(txt)) issues.push('Missing Rollback section');
