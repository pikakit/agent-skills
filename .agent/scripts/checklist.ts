...
const CORE_CHECKS: CheckConfig[] = [
    { name: 'Workflow Audit', script: '.agent/scripts/audit_workflows.ts', required: true },
    { name: 'Skill Audit', script: '.agent/scripts/skill-audit.ts', required: true },
    { name: 'Security Scan', script: '.agent/skills/knowledge-compiler/scripts/secret-scanner.ts', required: false },
