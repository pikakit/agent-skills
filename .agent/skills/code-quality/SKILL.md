...
description: >-
  ...
  Coordinates with: code-craft, code-review, test-architect.
allowed-tools: Read, Glob, Grep, Bash
metadata:
  category: "core"
  success_metrics: "lint passes, tsc passes, no security warnings"
  coordinates_with: "code-craft, code-review, test-architect"
---
