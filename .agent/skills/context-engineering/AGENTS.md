...
> **Note:**
> This document is for agents and LLMs to follow when working on context-engineering tasks.
...
This document compiles 1 rules across 1 categories for the Context Engineering skill. Monitor context usage, control token consumption with four-bucket strategy.
