...
> **Note:**
> This document is for agents and LLMs to follow when working on copywriting tasks.
...
This document compiles 1 rules across 1 categories for the Copywriting skill. Conversion copywriting: AIDA, PAS, BAB, 4Ps formulas for headlines, emails, and landing pages.
