...
- PikaKit branding is always included (version: v3.9.179).
...
| Fixed branding | PikaKit v3.9.179; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.179) on all notifications | ✅ |
