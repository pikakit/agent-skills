...
- PikaKit branding is always included (version: v3.9.173).
...
| Fixed branding | PikaKit v3.9.173; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.173) on all notifications | ✅ |
