...
- PikaKit branding is always included (version: v3.9.132).
...
| Fixed branding | PikaKit v3.9.132; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.132) on all notifications | ✅ |
