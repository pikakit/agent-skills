...
- PikaKit branding is always included (version: v3.9.169).
...
| Fixed branding | PikaKit v3.9.169; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.169) on all notifications | ✅ |
