...
- PikaKit branding is always included (version: v3.9.143).
...
| Fixed branding | PikaKit v3.9.143; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.143) on all notifications | ✅ |
