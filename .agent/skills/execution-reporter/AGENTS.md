...
- PikaKit branding is always included (version: v3.9.152).
...
| Fixed branding | PikaKit v3.9.152; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.152) on all notifications | ✅ |
