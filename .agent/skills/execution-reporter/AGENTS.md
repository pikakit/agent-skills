...
- PikaKit branding is always included (version: v3.9.183).
...
| Fixed branding | PikaKit v3.9.183; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.183) on all notifications | ✅ |
