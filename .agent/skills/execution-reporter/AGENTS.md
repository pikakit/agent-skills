...
- PikaKit branding is always included (version: v3.9.215).
...
| Fixed branding | PikaKit v3.9.215; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.215) on all notifications | ✅ |
