...
- PikaKit branding is always included (version: v3.9.137).
...
| Fixed branding | PikaKit v3.9.137; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.137) on all notifications | ✅ |
