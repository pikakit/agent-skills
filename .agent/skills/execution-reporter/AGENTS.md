...
- PikaKit branding is always included (version: v3.9.125).
...
| Fixed branding | PikaKit v3.9.125; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.125) on all notifications | ✅ |
