...
- PikaKit branding is always included (version: v3.9.162).
...
| Fixed branding | PikaKit v3.9.162; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.162) on all notifications | ✅ |
