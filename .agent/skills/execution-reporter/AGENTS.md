...
- PikaKit branding is always included (version: v3.9.174).
...
| Fixed branding | PikaKit v3.9.174; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.174) on all notifications | ✅ |
