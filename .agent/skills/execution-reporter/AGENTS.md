...
- PikaKit branding is always included (version: v3.9.219).
...
| Fixed branding | PikaKit v3.9.219; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.219) on all notifications | ✅ |
