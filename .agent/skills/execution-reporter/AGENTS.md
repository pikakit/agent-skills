...
- PikaKit branding is always included (version: v3.9.134).
...
| Fixed branding | PikaKit v3.9.134; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.134) on all notifications | ✅ |
