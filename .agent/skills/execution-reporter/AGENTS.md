...
- PikaKit branding is always included (version: v3.9.144).
...
| Fixed branding | PikaKit v3.9.144; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.144) on all notifications | ✅ |
