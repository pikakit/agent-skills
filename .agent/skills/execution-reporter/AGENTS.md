...
- PikaKit branding is always included (version: v3.9.217).
...
| Fixed branding | PikaKit v3.9.217; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.217) on all notifications | ✅ |
