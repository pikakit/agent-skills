...
- PikaKit branding is always included (version: v3.9.124).
...
| Fixed branding | PikaKit v3.9.124; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.124) on all notifications | ✅ |
