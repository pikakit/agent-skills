...
- PikaKit branding is always included (version: v3.9.222).
...
| Fixed branding | PikaKit v3.9.222; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.222) on all notifications | ✅ |
