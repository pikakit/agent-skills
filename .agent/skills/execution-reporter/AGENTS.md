...
- PikaKit branding is always included (version: v3.9.209).
...
| Fixed branding | PikaKit v3.9.209; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.209) on all notifications | ✅ |
