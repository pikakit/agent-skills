...
- PikaKit branding is always included (version: v3.9.131).
...
| Fixed branding | PikaKit v3.9.131; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.131) on all notifications | ✅ |
