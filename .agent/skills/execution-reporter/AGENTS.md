...
- PikaKit branding is always included (version: v3.9.153).
...
| Fixed branding | PikaKit v3.9.153; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.153) on all notifications | ✅ |
