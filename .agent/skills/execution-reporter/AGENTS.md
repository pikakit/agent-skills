...
- PikaKit branding is always included (version: v3.9.200).
...
| Fixed branding | PikaKit v3.9.200; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.200) on all notifications | ✅ |
