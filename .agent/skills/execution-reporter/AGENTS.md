...
- PikaKit branding is always included (version: v3.9.145).
...
| Fixed branding | PikaKit v3.9.145; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.145) on all notifications | ✅ |
