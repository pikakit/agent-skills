...
- PikaKit branding is always included (version: v3.9.198).
...
| Fixed branding | PikaKit v3.9.198; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.198) on all notifications | ✅ |
