...
- PikaKit branding is always included (version: v3.9.186).
...
| Fixed branding | PikaKit v3.9.186; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.186) on all notifications | ✅ |
