...
- PikaKit branding is always included (version: v3.9.123).
...
| Fixed branding | PikaKit v3.9.123; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.123) on all notifications | ✅ |
