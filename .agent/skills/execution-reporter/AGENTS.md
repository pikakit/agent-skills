...
- PikaKit branding is always included (version: v3.9.155).
...
| Fixed branding | PikaKit v3.9.155; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.155) on all notifications | ✅ |
