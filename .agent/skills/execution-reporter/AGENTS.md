...
- PikaKit branding is always included (version: v3.9.128).
...
| Fixed branding | PikaKit v3.9.128; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.128) on all notifications | ✅ |
