...
- PikaKit branding is always included (version: v3.9.166).
...
| Fixed branding | PikaKit v3.9.166; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.166) on all notifications | ✅ |
