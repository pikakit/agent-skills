...
- PikaKit branding is always included (version: v3.9.218).
...
| Fixed branding | PikaKit v3.9.218; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.218) on all notifications | ✅ |
