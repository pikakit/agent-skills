...
- PikaKit branding is always included (version: v3.9.170).
...
| Fixed branding | PikaKit v3.9.170; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.170) on all notifications | ✅ |
