...
- PikaKit branding is always included (version: v3.9.133).
...
| Fixed branding | PikaKit v3.9.133; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.133) on all notifications | ✅ |
