...
- PikaKit branding is always included (version: v3.9.130).
...
| Fixed branding | PikaKit v3.9.130; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.130) on all notifications | ✅ |
