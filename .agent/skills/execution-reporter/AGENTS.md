...
- PikaKit branding is always included (version: v3.9.122).
...
| Fixed branding | PikaKit v3.9.122; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.122) on all notifications | ✅ |
