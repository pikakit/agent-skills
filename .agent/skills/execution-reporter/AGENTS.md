...
- PikaKit branding is always included (version: v3.9.158).
...
| Fixed branding | PikaKit v3.9.158; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.158) on all notifications | ✅ |
