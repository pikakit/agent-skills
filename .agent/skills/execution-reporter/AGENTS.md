...
- PikaKit branding is always included (version: v3.9.176).
...
| Fixed branding | PikaKit v3.9.176; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.176) on all notifications | ✅ |
