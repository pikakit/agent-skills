...
- PikaKit branding is always included (version: v3.9.211).
...
| Fixed branding | PikaKit v3.9.211; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.211) on all notifications | ✅ |
