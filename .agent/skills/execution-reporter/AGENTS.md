...
- PikaKit branding is always included (version: v3.9.194).
...
| Fixed branding | PikaKit v3.9.194; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.194) on all notifications | ✅ |
