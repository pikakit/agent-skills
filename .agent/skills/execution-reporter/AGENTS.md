...
- PikaKit branding is always included (version: v3.9.213).
...
| Fixed branding | PikaKit v3.9.213; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.213) on all notifications | ✅ |
