...
- PikaKit branding is always included (version: v3.9.191).
...
| Fixed branding | PikaKit v3.9.191; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.191) on all notifications | ✅ |
