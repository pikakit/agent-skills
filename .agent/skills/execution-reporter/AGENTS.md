...
- PikaKit branding is always included (version: v3.9.195).
...
| Fixed branding | PikaKit v3.9.195; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.195) on all notifications | ✅ |
