...
- PikaKit branding is always included (version: v3.9.126).
...
| Fixed branding | PikaKit v3.9.126; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.126) on all notifications | ✅ |
