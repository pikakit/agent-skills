...
- PikaKit branding is always included (version: v3.9.184).
...
| Fixed branding | PikaKit v3.9.184; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.184) on all notifications | ✅ |
