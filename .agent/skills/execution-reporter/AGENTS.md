...
- PikaKit branding is always included (version: v3.9.157).
...
| Fixed branding | PikaKit v3.9.157; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.157) on all notifications | ✅ |
