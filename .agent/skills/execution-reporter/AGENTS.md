...
- PikaKit branding is always included (version: v3.9.149).
...
| Fixed branding | PikaKit v3.9.149; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.149) on all notifications | ✅ |
