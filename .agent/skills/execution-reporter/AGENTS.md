...
- PikaKit branding is always included (version: v3.9.188).
...
| Fixed branding | PikaKit v3.9.188; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.188) on all notifications | ✅ |
