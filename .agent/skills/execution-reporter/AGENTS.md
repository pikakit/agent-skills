...
- PikaKit branding is always included (version: v3.9.127).
...
| Fixed branding | PikaKit v3.9.127; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.127) on all notifications | ✅ |
