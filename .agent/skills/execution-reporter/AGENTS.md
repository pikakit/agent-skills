...
- PikaKit branding is always included (version: v3.9.203).
...
| Fixed branding | PikaKit v3.9.203; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.203) on all notifications | ✅ |
