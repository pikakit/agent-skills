...
- PikaKit branding is always included (version: v3.9.196).
...
| Fixed branding | PikaKit v3.9.196; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.196) on all notifications | ✅ |
