...
- PikaKit branding is always included (version: v3.9.208).
...
| Fixed branding | PikaKit v3.9.208; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.208) on all notifications | ✅ |
