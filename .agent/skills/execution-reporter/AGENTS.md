...
- PikaKit branding is always included (version: v3.9.165).
...
| Fixed branding | PikaKit v3.9.165; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.165) on all notifications | ✅ |
