...
- PikaKit branding is always included (version: v3.9.210).
...
| Fixed branding | PikaKit v3.9.210; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.210) on all notifications | ✅ |
