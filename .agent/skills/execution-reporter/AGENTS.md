...
- PikaKit branding is always included (version: v3.9.212).
...
| Fixed branding | PikaKit v3.9.212; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.212) on all notifications | ✅ |
