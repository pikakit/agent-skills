...
- PikaKit branding is always included (version: v3.9.214).
...
| Fixed branding | PikaKit v3.9.214; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.214) on all notifications | ✅ |
