...
- PikaKit branding is always included (version: v3.9.160).
...
| Fixed branding | PikaKit v3.9.160; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.160) on all notifications | ✅ |
