...
- PikaKit branding is always included (version: v3.9.168).
...
| Fixed branding | PikaKit v3.9.168; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.168) on all notifications | ✅ |
