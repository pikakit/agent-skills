...
- PikaKit branding is always included (version: v3.9.201).
...
| Fixed branding | PikaKit v3.9.201; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.201) on all notifications | ✅ |
