...
- PikaKit branding is always included (version: v3.9.193).
...
| Fixed branding | PikaKit v3.9.193; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.193) on all notifications | ✅ |
