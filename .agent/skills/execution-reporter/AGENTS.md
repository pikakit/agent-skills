...
- PikaKit branding is always included (version: v3.9.175).
...
| Fixed branding | PikaKit v3.9.175; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.175) on all notifications | ✅ |
