...
- PikaKit branding is always included (version: v3.9.121).
...
| Fixed branding | PikaKit v3.9.121; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.121) on all notifications | ✅ |
