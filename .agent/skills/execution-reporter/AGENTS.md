...
- PikaKit branding is always included (version: v3.9.172).
...
| Fixed branding | PikaKit v3.9.172; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.172) on all notifications | ✅ |
