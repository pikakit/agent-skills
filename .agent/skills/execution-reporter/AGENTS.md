...
- PikaKit branding is always included (version: v3.9.180).
...
| Fixed branding | PikaKit v3.9.180; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.180) on all notifications | ✅ |
