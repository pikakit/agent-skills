...
- PikaKit branding is always included (version: v3.9.156).
...
| Fixed branding | PikaKit v3.9.156; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.156) on all notifications | ✅ |
