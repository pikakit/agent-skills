...
- PikaKit branding is always included (version: v3.9.204).
...
| Fixed branding | PikaKit v3.9.204; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.204) on all notifications | ✅ |
