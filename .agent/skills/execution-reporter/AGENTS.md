...
- PikaKit branding is always included (version: v3.9.151).
...
| Fixed branding | PikaKit v3.9.151; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.151) on all notifications | ✅ |
