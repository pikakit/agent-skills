...
- PikaKit branding is always included (version: v3.9.177).
...
| Fixed branding | PikaKit v3.9.177; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.177) on all notifications | ✅ |
