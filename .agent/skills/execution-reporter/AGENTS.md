...
- PikaKit branding is always included (version: v3.9.190).
...
| Fixed branding | PikaKit v3.9.190; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.190) on all notifications | ✅ |
