...
- PikaKit branding is always included (version: v3.9.129).
...
| Fixed branding | PikaKit v3.9.129; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.129) on all notifications | ✅ |
