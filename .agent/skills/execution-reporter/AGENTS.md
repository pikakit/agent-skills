...
- PikaKit branding is always included (version: v3.9.141).
...
| Fixed branding | PikaKit v3.9.141; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.141) on all notifications | ✅ |
