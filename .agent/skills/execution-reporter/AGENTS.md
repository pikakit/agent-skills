...
- PikaKit branding is always included (version: v3.9.192).
...
| Fixed branding | PikaKit v3.9.192; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.192) on all notifications | ✅ |
