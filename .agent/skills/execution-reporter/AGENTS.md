...
- PikaKit branding is always included (version: v3.9.142).
...
| Fixed branding | PikaKit v3.9.142; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.142) on all notifications | ✅ |
