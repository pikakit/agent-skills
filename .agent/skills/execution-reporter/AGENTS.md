...
- PikaKit branding is always included (version: v3.9.136).
...
| Fixed branding | PikaKit v3.9.136; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.136) on all notifications | ✅ |
