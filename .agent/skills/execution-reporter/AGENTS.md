...
- PikaKit branding is always included (version: v3.9.216).
...
| Fixed branding | PikaKit v3.9.216; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.216) on all notifications | ✅ |
