...
- PikaKit branding is always included (version: v3.9.161).
...
| Fixed branding | PikaKit v3.9.161; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.161) on all notifications | ✅ |
