...
- PikaKit branding is always included (version: v3.9.167).
...
| Fixed branding | PikaKit v3.9.167; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.167) on all notifications | ✅ |
