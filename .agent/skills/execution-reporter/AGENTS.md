...
- PikaKit branding is always included (version: v3.9.205).
...
| Fixed branding | PikaKit v3.9.205; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.205) on all notifications | ✅ |
