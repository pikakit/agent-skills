...
- PikaKit branding is always included (version: v3.9.221).
...
| Fixed branding | PikaKit v3.9.221; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.221) on all notifications | ✅ |
