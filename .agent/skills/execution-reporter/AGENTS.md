...
- PikaKit branding is always included (version: v3.9.146).
...
| Fixed branding | PikaKit v3.9.146; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.146) on all notifications | ✅ |
