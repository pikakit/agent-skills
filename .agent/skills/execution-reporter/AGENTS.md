...
- PikaKit branding is always included (version: v3.9.159).
...
| Fixed branding | PikaKit v3.9.159; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.159) on all notifications | ✅ |
