...
- PikaKit branding is always included (version: v3.9.197).
...
| Fixed branding | PikaKit v3.9.197; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.197) on all notifications | ✅ |
