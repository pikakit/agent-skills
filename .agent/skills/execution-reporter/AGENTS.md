...
- PikaKit branding is always included (version: v3.9.199).
...
| Fixed branding | PikaKit v3.9.199; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.199) on all notifications | ✅ |
