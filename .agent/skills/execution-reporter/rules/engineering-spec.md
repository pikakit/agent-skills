...
- PikaKit branding is always included (version: v3.9.119).
...
| Fixed branding | PikaKit v3.9.119; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.119) on all notifications | ✅ |
