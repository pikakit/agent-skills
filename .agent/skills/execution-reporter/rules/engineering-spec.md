...
- PikaKit branding is always included (version: v3.9.111).
...
| Fixed branding | PikaKit v3.9.111; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.111) on all notifications | ✅ |
