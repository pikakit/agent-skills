...
- PikaKit branding is always included (version: v3.9.120).
...
| Fixed branding | PikaKit v3.9.120; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.120) on all notifications | ✅ |
