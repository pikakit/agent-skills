...
- PikaKit branding is always included (version: v3.9.116).
...
| Fixed branding | PikaKit v3.9.116; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.116) on all notifications | ✅ |
