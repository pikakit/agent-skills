...
- PikaKit branding is always included (version: v3.9.113).
...
| Fixed branding | PikaKit v3.9.113; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.113) on all notifications | ✅ |
