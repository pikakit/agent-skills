...
- PikaKit branding is always included (version: v3.9.112).
...
| Fixed branding | PikaKit v3.9.112; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.112) on all notifications | ✅ |
