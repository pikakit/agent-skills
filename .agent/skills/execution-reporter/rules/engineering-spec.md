...
- PikaKit branding is always included (version: v3.9.115).
...
| Fixed branding | PikaKit v3.9.115; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.115) on all notifications | ✅ |
