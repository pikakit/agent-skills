...
- PikaKit branding is always included (version: v3.9.118).
...
| Fixed branding | PikaKit v3.9.118; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.118) on all notifications | ✅ |
