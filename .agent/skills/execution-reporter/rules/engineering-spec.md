...
- PikaKit branding is always included (version: v3.9.117).
...
| Fixed branding | PikaKit v3.9.117; not configurable |
...
| **Functionality** | PikaKit branding (v3.9.117) on all notifications | ✅ |
