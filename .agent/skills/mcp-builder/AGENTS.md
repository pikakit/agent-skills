...
description: MCP design patterns â€” workflow over endpoints, concise/detailed output, actionable errors, naming conventions
---
...
description: Core MCP concepts â€” tool/resource/prompt design, transport selection, error handling, security patterns
---
...
---
name: mcp-evaluation
description: 10-question evaluation framework for MCP servers â€” complex, read-only, verifiable test questions
---
...
description: Python MCP server with FastMCP â€” tool annotations, error helpers, pagination, quality checklist
---
...
description: TypeScript MCP server with Zod validation â€” tool annotations, strict mode, build/test workflow
---
