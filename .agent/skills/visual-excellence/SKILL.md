...
description: >-
  ...
  Use when building UI/UX, analyzing designs, implementing visual hierarchy and color theory.
  Triggers on: visual, aesthetic, design quality, polish.
  Coordinates with: design-system, tailwind-kit, studio.
metadata:
  category: "architecture"
  success_metrics: "design polished, visual consistency"
  coordinates_with: "design-system, tailwind-kit, studio"
---
