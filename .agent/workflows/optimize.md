...
- `database-tuner` - Query optimization, index recommendations
- `cache-optimizer` - Redis caching, CDN configuration
- `load-tester` - k6/Artillery load testing, scalability validation
...
Agent: Loading performance-audit chain
       ↓
Skills: perf-optimizer, database-tuner, cache-optimizer, load-tester
       ↓
